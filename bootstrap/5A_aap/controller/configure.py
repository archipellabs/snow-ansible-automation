...
def main():
    ...
    # (bootstrap/5A_aap/controller/inventory.now.yml, servicenow.itsm.now). The ServiceNow credential
    ...
    src = get_or_create(
        ...
        {"name": "ServiceNow CMDB", "inventory": inv["id"], "source": "scm",
         "source_project": proj["id"], "source_path": "bootstrap/5A_aap/controller/inventory.now.yml",
